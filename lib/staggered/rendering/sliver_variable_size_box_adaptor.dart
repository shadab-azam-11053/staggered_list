import 'package:staggered_list/staggered/rendering/tile_container_render_object_mixin.dart';
...
/// the total scroll offset extent occupied by the full child staggered.
abstract class RenderSliverVariableSizeBoxChildManager {
  ...
  /// inserted into the child staggered in the appropriate position. Its index and
  ...
  /// Remove the given child from the child staggered.
  ///
  ...
  /// child's index in the child staggered after this function returns.
  ...
  /// modifications to the [RenderSliverVariableSizeBoxAdaptor]'s child staggered.
  ///
  /// This function always returns true.
  ///
  /// The manager is not required to track whether it is expecting modifications
  /// to the [RenderSliverVariableSizeBoxAdaptor]'s child staggered and can simply return
...
abstract class RenderSliverVariableSizeBoxAdaptor extends RenderSliver
  ...
  ///
  /// Rather than having a concrete staggered of children, a
